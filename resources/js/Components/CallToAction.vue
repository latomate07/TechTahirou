    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div v-if="isOnBlog" class="mx-auto max-w-screen-md sm:text-center">
                ...
                <p class="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">Restez au courant des nouveautés, n'hésitez pas à vous inscrire avec votre email.</p>
                <form action="#">
