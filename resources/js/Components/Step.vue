<template>
    <section class="text-gray-600 body-font md:mb-0 mb-20">
        <div class="container px-5 md:pt-24 pt-10 mx-auto flex flex-wrap">
            <div class="flex flex-wrap w-full">
                ...
                <img class="lg:w-3/5 md:w-1/2 object-cover object-center md:h-[80%] rounded-lg md:mt-0 mt-12 w-full h-60" src="/storage/images/step-image.jpg" alt="step">
            </div>
        </div>
    </section>
</template>
