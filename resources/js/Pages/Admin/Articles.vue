            ...
            <div class="max-w-[85vw] md:max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex md:flex-row flex-col justify-between items-center overflow-hidden sm:rounded-lg">
                    ...
                    <div class="md:mt-0 md:mr-2 mt-5 mr-auto">
                        <Link :href="route('dashboard.articles.create')" class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                            Ajouter
