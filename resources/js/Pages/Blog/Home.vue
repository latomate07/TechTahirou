    ...
    <MainLayout>
        <section class="bg-white dark:bg-darkmode">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div class="grid grid-flow-row gap-8 lg:grid-cols-2">
                    <article v-for="post in posts.data" :key="post.id" class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 max-w-[92vw]">
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400 truncate">{{ post.content }}</p>
