                ...
                <div class="grid md:grid-cols-3 grid-cols-2 gap-2">
                    <div class="bg-white dark:bg-gray-600 dark:text-white rounded p-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-2">{{ portfolioStatistic?.max_views ?? 0 }} vues</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"></path>
                            </svg>
                            <span class="ml-2">{{ portfolioStatistic?.max_liked ?? 0 }} likes</span>
                        </div>
                    </div>
                    <div class="bg-white dark:bg-gray-600 dark:text-white rounded p-4">
                ...
                <form @submit.prevent="saveCategories">
                    <div class="grid md:grid-cols-2 grid-flow-row gap-5">
                        <div>
                            ...
                            <input v-model="categoryForm.category" type="text" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500">
                        ...
                        <div>
                            ...
                            <input v-model="categoryForm.sub_category" type="text" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500">
                        ...
                        <div>
                            ...
                            <select v-model="categoryForm.post_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 cursor-pointer">
                    ...
                    <button type="submit" class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 mt-4 dark:bg-yellow-600 dark:hover:bg-yellow-700 focus:outline-none dark:focus:ring-yellow-800">Enregistrer</button>
                </form>
            </div>
        </div>
    </AuthenticatedLayout>
